...
--changeset release151101:151101-10
update posicionamento_proposicao set preliminar = true where posicionamento_id in (select id from posicionamento where nome like 'Previamente%');
--rollback update posicionamento_proposicao set preliminar = false

--changeset release151101:151101-11
ALTER TABLE public.proposicao DROP posicionamento;
