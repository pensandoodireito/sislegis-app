...
class TarefaEndpointSpec extends Specification{
    ...
    def "deve alterar uma tarefa"(){
        ...
        def dados = [id: 146, data: 1444878216978, tipoTarefa: "ENCAMINHAMENTO", encaminhamentoProposicao: [id: 144, comentario: [id: 145, descricao: "asldfjasl", autor: [id: 140, nome: "Gustavo Delgado", email: "gcdelgado@gmail.com"], dataCriacao: 1444878216936, proposicao: null], encaminhamento: [id: 18, nome: "Apenas Monitorar"], proposicao: [id: 142, idProposicao: null, tipo: null, ano: null, numero: null, autor: null, origem: null, resultadoASPAR: null, listaReuniaoProposicoes: null, comissao: null, seqOrdemPauta: null, sigla: "null null/null", ementa: null, linkProposicao: null, linkPauta: null, posicionamento: null, responsavel: null, tags: null, listaComentario: [], listaEncaminhamentoProposicao: [], reuniao: null, proposicoesPai: null, proposicoesFilha: null, elaboracoesNormativas: null, favorita: false], responsavel: [id: 140, nome: "Gustavo Delgado", email: "gcdelgado@gmail.com"], dataHoraLimite: 1444964400000], usuario: [id: 140, nome: "Gustavo Delgado", email: "gcdelgado@gmail.com"], proposicao: null, comentarioFinalizacao: "FINALIZADA FINALMENTE", finalizada: true, visualizada: false]
