...
public class SeiServiceLocator extends org.apache.axis.client.Service implements br.gov.mj.sislegis.app.seiws.SeiService {
    ...
    private java.lang.String SeiPortService_address = "http://localhost:8081/sei/ws/SeiWS.php";
    ...
    public br.gov.mj.sislegis.app.seiws.SeiPortType getSeiPortService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            br.gov.mj.sislegis.app.seiws.SeiBindingStub _stub = new br.gov.mj.sislegis.app.seiws.SeiBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (br.gov.mj.sislegis.app.seiws.SeiPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                br.gov.mj.sislegis.app.seiws.SeiBindingStub _stub = new br.gov.mj.sislegis.app.seiws.SeiBindingStub(new java.net.URL(SeiPortService_address), this);
                _stub.setPortName(getSeiPortServiceWSDDServiceName());
                return _stub;
            }
        }
